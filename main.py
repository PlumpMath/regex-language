...
print("\n")
print("Matching aaaaa with the regex (a*)?aaaaa returns..." + str(regex_matching("aaaaa", "(a*)?aaaaa")))
print("\n")
print("Matching add with the regex (ad)*d* returns..." + str(regex_matching("add", "(ad)*d*")))
print("\n")
print("Matching aab with the regex a?aab returns..." + str(regex_matching("aab", "a?aab")))
print("\n")
